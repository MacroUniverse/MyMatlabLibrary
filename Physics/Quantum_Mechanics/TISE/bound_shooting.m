...
[x1, Y1] = bound_shooting_half(E, V, [xmin,xmid], mass, dy, odeOpt);
[x2, Y2] = bound_shooting_half(E, V, [xmax,xmid], mass, dy, odeOpt);
...
function [x, Y] = bound_shooting_half(E, V, xspan, mass, dy, odeOpt)
if V(xspan(1)) > E
